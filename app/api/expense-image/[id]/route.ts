...
/** Proxies GET /api/Expense/{id}/attachment with Authorization (browser img cannot send Bearer). */
export async function GET(request: NextRequest, context: { params: Promise<{ id: string }> }) {
  ...
  const upstream = `${farmBaseUrl()}/api/Expense/${id}/attachment?${q.toString()}`
