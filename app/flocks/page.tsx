...
export default function FlocksPage() {
  ...
  // Total Birds Left = Overall Total Birds - Total Mortality
  const totalBirdsLeft = useMemo(() => {
    return overallTotalBirds - totalMortality
  }, [overallTotalBirds, totalMortality])
                    ...
                    <div className={cn("flex gap-3", isMobile ? "flex-col items-start" : "items-center justify-between")}>
                      <div className="flex items-center gap-2">
                        ...
                        <div>
                          ...
                          <span className="text-xs text-slate-500 block">Currently remaining birds</span>
                        </div>
                      </div>
