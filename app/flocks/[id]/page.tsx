...
import { Bird, ArrowLeft, Loader2, Save, Users, Home } from "lucide-react"
...
export default function EditFlockPage() {
  ...
  const load = async () => {
    ...
    if (flockRes.success && flockRes.data) {
      ...
      console.log("[v0] Loaded flock data - houseId:", flock.houseId, "batchId:", flock.batchId)
            ...
            <div className="space-y-6 max-w-3xl">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-slate-600 text-sm">Loading flock information...</p>
                </div>
              </div>
        ...
        <main className="overflow-y-visible overflow-x-hidden p-4 sm:p-6 pb-16 lg:pb-4 min-w-0">
          <div className="space-y-6 max-w-3xl">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-2xl font-bold text-slate-900">Edit Flock</h1>
                <p className="text-slate-600 text-sm">Update the flock information below</p>
              </div>
            </div>
              ...
              <div className="flex gap-3 justify-end pt-2">
                ...
                >
                  {saving ? (
                    ...
                    <><Save className="w-4 h-4 mr-2" />Update Flock</>
                  )}
                </Button>
              </div>
            </form>
