...
-- Cost Per Chick, Total Cost, Supplier Type (local/foreign), Supplier (FK to
-- dbo.Supplier), and an explicit active/inactive Status.
--
...
BEGIN
    ...
    (
        ...
        [CostPerChick], [TotalCost], [SupplierType], [SupplierId],
        [CreatedDate]
    )
    VALUES
    (
        ...
        ISNULL(@CostPerChick, 0), ISNULL(@TotalCost, 0), @SupplierType, @SupplierId,
        SYSUTCDATETIME()
    );
...
BEGIN
    ...
    SELECT
        ...
        b.[Status], b.[CostPerChick], b.[TotalCost], b.[SupplierType], b.[SupplierId],
