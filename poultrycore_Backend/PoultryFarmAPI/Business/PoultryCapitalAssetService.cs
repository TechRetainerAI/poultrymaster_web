...
namespace PoultryFarmAPIWeb.Business
{
    public interface IPoultryCapitalAssetService
    {
        ...
        /// <summary>
        /// 313. Corrects the ORIGINAL acquisition cost by appending a signed
        ...
        /// </summary>
        Task<int> CorrectOriginalCostAsync(int assetId, PoultryCapitalAssetCorrectCostRequest r);
        /// <summary>
        /// 313. Reverses ONE additional capitalised cost. The row is kept and
        /// marked Reversed -- nothing is deleted.
        /// </summary>
        Task ReverseCostAsync(int assetId, int costId, PoultryReversalRequest r);
    ...
    public class PoultryCapitalAssetService : IPoultryCapitalAssetService
    {
        ...
        private static PoultryCapitalAssetModel MapAsset(NpgsqlDataReader r) => new()
        {
            ...
            // 313. The same total, split into the two halves that explain it.
        ...
        private static PoultryCapitalAssetCostModel MapCost(NpgsqlDataReader r) => new()
        {
            ...
            // 313. What "where did this money go?" actually needs, read off the
        ...
        public async Task<int> CorrectOriginalCostAsync(int assetId, PoultryCapitalAssetCorrectCostRequest q)
        {
            using var conn = new NpgsqlConnection(_cs);
            ...
            using var cmd = new NpgsqlCommand(
                "SELECT * FROM sppoultrycapitalasset_correctoriginalcost(p_farmid => @FarmId::text, " +
        ...
        public async Task ReverseCostAsync(int assetId, int costId, PoultryReversalRequest q)
        {
            using var conn = new NpgsqlConnection(_cs);
            ...
            using var cmd = new NpgsqlCommand(
                "SELECT * FROM sppoultrycapitalassetcost_reverse(p_farmid => @FarmId::text, " +
