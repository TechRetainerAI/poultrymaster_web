...
// Same SqlConnection + SP pattern as PoultryCashServices.cs. Payroll item CRUD
...
namespace PoultryFarmAPIWeb.Business
{
    ...
    public class PoultryStaffService : IPoultryStaffService
    {
        ...
        public async Task<List<PoultryStaffModel>> GetAllAsync(string farmId, string? role)
        {
            ...
            using var cmd = new SqlCommand("spPoultryStaff_GetAll", c) { CommandType = CommandType.StoredProcedure };
        ...
        {
            using var c = new SqlConnection(_cs);
            using var cmd = new SqlCommand("spPoultryStaff_GetById", c) { CommandType = CommandType.StoredProcedure };
        ...
        {
            using var c = new SqlConnection(_cs);
            using var cmd = new SqlCommand("spPoultryStaff_Insert", c) { CommandType = CommandType.StoredProcedure };
        ...
        {
            using var c = new SqlConnection(_cs);
            using var cmd = new SqlCommand("spPoultryStaff_Update", c) { CommandType = CommandType.StoredProcedure };
        ...
        {
            using var c = new SqlConnection(_cs);
            using var cmd = new SqlCommand("spPoultryStaff_Delete", c) { CommandType = CommandType.StoredProcedure };
            cmd.Parameters.AddWithValue("@PoultryStaffId", id);
            cmd.Parameters.AddWithValue("@FarmId", farmId);
            await c.OpenAsync();
            await cmd.ExecuteNonQueryAsync();
        ...
        private static PoultryStaffModel Read(SqlDataReader r) => new()
        {
    ...
    public class PoultryStaffAttendanceService : IPoultryStaffAttendanceService
    {
        ...
        public async Task<List<PoultryStaffAttendanceModel>> GetAllAsync(string farmId, int? staffId, DateTime? fromDate, DateTime? toDate)
        {
            ...
            using var c = new SqlConnection(_cs);
            using var cmd = new SqlCommand("spPoultryStaffAttendance_GetAll", c) { CommandType = CommandType.StoredProcedure };
            cmd.Parameters.AddWithValue("@FarmId", farmId);
        ...
        {
            using var c = new SqlConnection(_cs);
            using var cmd = new SqlCommand("spPoultryStaffAttendance_Upsert", c) { CommandType = CommandType.StoredProcedure };
            cmd.Parameters.AddWithValue("@FarmId", farmId);
        ...
        {
            using var c = new SqlConnection(_cs);
            using var cmd = new SqlCommand("spPoultryStaffAttendance_Delete", c) { CommandType = CommandType.StoredProcedure };
        ...
        private static PoultryStaffAttendanceModel Read(SqlDataReader r)
        {
    ...
    public class PoultryPayrollService : IPoultryPayrollService
    {
        ...
        public async Task<List<PoultryPayrollRunModel>> GetRunsAsync(string farmId, string? status)
        {
            ...
            using var c = new SqlConnection(_cs);
            using var cmd = new SqlCommand("spPoultryPayrollRun_GetAll", c) { CommandType = CommandType.StoredProcedure };
            cmd.Parameters.AddWithValue("@FarmId", farmId);
        ...
        {
            using var c = new SqlConnection(_cs);
            using var cmd = new SqlCommand("spPoultryPayrollRun_GetById", c) { CommandType = CommandType.StoredProcedure };
        ...
        {
            using var c = new SqlConnection(_cs);
            using var cmd = new SqlCommand("spPoultryPayrollRun_Insert", c) { CommandType = CommandType.StoredProcedure };
        ...
        {
            using var c = new SqlConnection(_cs);
            using var cmd = new SqlCommand("spPoultryPayrollItem_Upsert", c) { CommandType = CommandType.StoredProcedure };
        ...
        {
            using var c = new SqlConnection(_cs);
            using var cmd = new SqlCommand("spPoultryPayrollItem_Delete", c) { CommandType = CommandType.StoredProcedure };
        ...
        {
            using var c = new SqlConnection(_cs);
            using var cmd = new SqlCommand("spPoultryPayrollRun_Approve", c) { CommandType = CommandType.StoredProcedure };
            cmd.Parameters.AddWithValue("@PoultryPayrollRunId", runId);
            cmd.Parameters.AddWithValue("@FarmId", farmId);
        ...
        {
            using var c = new SqlConnection(_cs);
            using var cmd = new SqlCommand("spPoultryPayrollRun_MarkPaid", c) { CommandType = CommandType.StoredProcedure };
            cmd.Parameters.AddWithValue("@PoultryPayrollRunId", runId);
            cmd.Parameters.AddWithValue("@FarmId", farmId);
        ...
        {
            using var c = new SqlConnection(_cs);
            using var cmd = new SqlCommand("spPoultryPayrollRun_Cancel", c) { CommandType = CommandType.StoredProcedure };
            cmd.Parameters.AddWithValue("@PoultryPayrollRunId", runId);
            cmd.Parameters.AddWithValue("@FarmId", farmId);
        ...
        {
            using var c = new SqlConnection(_cs);
            using var cmd = new SqlCommand("spPoultryPayrollRun_Unapprove", c) { CommandType = CommandType.StoredProcedure };
            cmd.Parameters.AddWithValue("@PoultryPayrollRunId", runId);
            cmd.Parameters.AddWithValue("@FarmId", farmId);
        ...
        {
            using var c = new SqlConnection(_cs);
            using var cmd = new SqlCommand("spPoultryPayrollRun_Delete", c) { CommandType = CommandType.StoredProcedure };
            cmd.Parameters.AddWithValue("@PoultryPayrollRunId", runId);
            cmd.Parameters.AddWithValue("@FarmId", farmId);
        ...
        {
            using var c = new SqlConnection(_cs);
            using var cmd = new SqlCommand("spPoultryPayrollRun_GetDetailsWithYtd", c) { CommandType = CommandType.StoredProcedure };
            cmd.Parameters.AddWithValue("@PoultryPayrollRunId", runId);
            cmd.Parameters.AddWithValue("@FarmId", farmId);
            await c.OpenAsync();
            using var r = await cmd.ExecuteReaderAsync();
        ...
        private static PoultryPayrollRunModel ReadRun(SqlDataReader r) => new()
        {
        ...
        private static PoultryPayrollItemModel ReadItem(SqlDataReader r)
        {
