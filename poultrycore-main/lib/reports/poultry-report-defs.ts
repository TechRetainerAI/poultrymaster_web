...
export const POULTRY_REPORT_DEFS: Record<PoultryReportSlug, PoultryReportDef> = {
  ...
  "daily-egg-production": {
    ...
    columns: [
      ...
      { header: "9 AM", align: "right", cell: (r, c) => c.num(r.morningEggs) },
      { header: "12 PM", align: "right", cell: (r, c) => c.num(r.middayEggs) },
      { header: "4 PM", align: "right", cell: (r, c) => c.num(r.eveningEggs) },
