      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto p-4 sm:p-6 space-y-4">
          ...
          <div className="flex items-center gap-2">
            <Button variant="ghost" size="sm" className="gap-1" onClick={() => router.push("/poultry-assets")}>
          ...
          <div className="grid gap-3 lg:grid-cols-3">
            ...
            <Card><CardContent className="p-4 space-y-1.5">
              ...
              {/* 313. One number called "Original cost" was the TOTAL, so
                  a capital investment bought for 100,000 and improved twice read as
