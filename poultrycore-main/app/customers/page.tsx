                  ...
                  {isMobile && !showAllColumnsMobile ? (
                    <div className="space-y-3">
                      {currentCustomers.map((customer, idx) => (
                        <Collapsible key={customer.customerId} defaultOpen className={cn("group rounded-xl border shadow-sm overflow-hidden", idx % 2 === 0 ? "bg-amber-100 border-amber-300" : "bg-white border-slate-200")}>
                        ...
                        {currentCustomers.map((customer) => (
                          <TableRow key={customer.customerId} className="hover:bg-slate-50 transition-colors">
                            ...
                            <TableCell className="text-slate-600 hidden xl:table-cell">
                              {(customer as any).createdDate ? fmtInstant((customer as any).createdDate) : "-"}
                            </TableCell>
